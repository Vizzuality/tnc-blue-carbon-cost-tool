...
describe('Calculations - Create Mangrove Restoration Project in Indonesia (230 ha)', () => {
  ...
  const expectedInitialCarbonPrice: CustomProjectOutput['initialCarbonPriceComputationOutput'] =
    expectedOutput.initialCarbonPriceComputationOutput;
  const expectedBreakEvenPrice: CustomProjectOutput['breakevenPriceComputationOutput'] =
    expectedOutput.breakevenPriceComputationOutput;
