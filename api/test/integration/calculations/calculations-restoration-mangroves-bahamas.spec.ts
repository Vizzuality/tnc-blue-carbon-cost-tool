...
const createDTO = {
  ...
  costInputs: {
    ...
    establishingCarbonRights: 106666.666666667,
    validation: 50000,
    implementationLabor: 26645,
    monitoring: 33300,
    maintenance: 0.0833,
    communityBenefitSharingFund: 0.85,
...
// TO update after merging smoke test PR
describe.skip('Calculations Tests Case: Restoration Mangroves Bahamas', () => {
  ...
  test('Full Restoration Project Output', async () => {
    const output = customProjectOutput as unknown as RestorationProjectOutput;
    console.log('Full Restoration Project Output:', output);
