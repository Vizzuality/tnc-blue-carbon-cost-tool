...
export type ParsedEntities = {
  ...
  dataCollectionAndFieldCosts: ParsedEntity<DataCollectionAndFieldCosts>;
  communityRepresentation: ParsedEntity<CommunityRepresentation>;
  blueCarbonProjectPlanning: ParsedEntity<BlueCarbonProjectPlanning>;
  establishingCarbonRights: ParsedEntity<CarbonRights>;
  financingCost: ParsedEntity<FinancingCost>;
  validationCost: ParsedEntity<ValidationCost>;
  monitoringCost: ParsedEntity<MonitoringCost>;
  maintenanceCost: ParsedEntity<Maintenance>;
  communityBenefit: ParsedEntity<CommunityBenefitSharingFund>;
  baselineReassessment: ParsedEntity<BaselineReassessment>;
  mrv: ParsedEntity<MRV>;
  longTermProjectOperating: ParsedEntity<LongTermProjectOperating>;
  carbonStandardFees: ParsedEntity<CarbonStandardFees>;
  communityCashFlow: ParsedEntity<CommunityCashFlow>;
  ecosystemExtent: ParsedEntity<EcosystemExtent>;
  ecosystemLoss: ParsedEntity<EcosystemLoss>;
  restorableLand: ParsedEntity<RestorableLand>;
  sequestrationRate: ParsedEntity<SequestrationRate>;
  emissionFactors: ParsedEntity<EmissionFactors>;
  implementationLaborCost: ParsedEntity<ImplementationLaborCost>;
  baseSize: ParsedEntity<BaseSize>;
  baseIncrease: ParsedEntity<BaseIncrease>;
  modelAssumptions: ParsedEntity<ModelAssumptions>;
};

export type ParsedEntitiesWithSources = ParsedEntities & {
  modelComponentSourceM2M: ParsedEntity<ModelComponentSourceM2M>;
};
