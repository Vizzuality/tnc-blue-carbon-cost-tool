...
export type MethodologySourceConfigType = {
  entity: (typeof COMMON_DATABASE_ENTITIES)[number];
  label: string;
  category: 'Carbon' | 'Costs' | 'Economic factors';
  relationshipType: '1n' | 'm2m';
};
...
export const MethodologySourcesConfig: MethodologySourceConfigType[] = [
  // Carbon
  {
